...
immune_cells = ['CD8 T', 'Mac', 'Neut', 'DC', 'CD4 T', 'Fib', 'virion', 'IFN', 'Ig', 'pro-I', 'anti-I', 'collagen']
set1 = ['CD8 T', 'Mac', 'Neut', 'DC', 'CD4 T', 'Fib']
set2 = ['vir', 'IFN']
set3 = ['Ig']
set4 = ['pI', 'aI']
set5 = ['col']
...
for i in range(1):
    ...
    for j in range( len(set1) ):
        ...
        ax.fill_between(t, cells[i,j,:]-cells[i,j+12,:], cells[i,j,:]+cells[i,j+12,:], 
...
for i in range(1):
    ...
    for j in range( len(set1), len(set1)+1, 1):
        ...
        ax1.fill_between(t, cells[i,j,:]-cells[i,j+12,:], cells[i,j,:]+cells[i,j+12,:], 
    ...
    for j in range( len(set1)+1, len(set1)+len(set2), 1):
        ...
        ax2.fill_between(t, cells[i,j,:]-cells[i,j+12,:], cells[i,j,:]+cells[i,j+12,:], 
