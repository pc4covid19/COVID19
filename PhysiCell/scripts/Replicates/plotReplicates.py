...
colorv = ['red' , 'blue', 'darkgreen', 'orange', 'yellow', 'cyan', 'purple']
colorv2 = ['red' , 'blue', 'darkgreen', 'orange']
...
for i in range(1):
    ...
    for j in range( len(immun_r) ):
        ax.plot(t, immun_r[j,:], color= colorv[j], linewidth=2)
